...
Namespace BDArtLimpieza
    Public Class ConnectionHelper
        ...
        Public Shared Function GetPersistentTypes() As Type()
            ...
            Return copy
        End Function
        Public Const ConnectionString As String = "XpoProvider=MSSqlServer;data source=localhost\sqlexpress;initial catalog=BDArtLimpieza;Persist Security Info=true"
