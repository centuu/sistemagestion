...
Public Class REMITOR
    ...
    Private Sub XrLabel30_BeforePrint(sender As Object, e As PrintEventArgs) Handles XrLabel30.BeforePrint
        XrLabel30.Text = TipoRemito
    End Sub
    Private Sub XrLabel9_BeforePrint(sender As Object, e As PrintEventArgs) Handles XrLabel9.BeforePrint
        If TipoRemito = "DUPLICADO" Then
            XrLabel9.Text = "RECIBÍ CONFORME: ____________________________"
        Else
            XrLabel9.Text = ""
        End If
    End Sub
    ...
    Private Sub XrLabel10_BeforePrint(sender As Object, e As PrintEventArgs) Handles XrLabel10.BeforePrint
        XrLabel10.Text = "C.A.I. " & caiEmpresa
    End Sub
    Private Sub XrLabel23_BeforePrint(sender As Object, e As PrintEventArgs) Handles XrLabel23.BeforePrint
        XrLabel23.Text = "Fecha Vto. " & vtoCaiEmpresa
    End Sub
