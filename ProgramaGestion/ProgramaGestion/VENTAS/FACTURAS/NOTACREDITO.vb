...
Public Class NOTACREDITO
    Private Sub XrLabel9_BeforePrint(sender As Object, e As PrintEventArgs) Handles XrLabel9.BeforePrint
        If TipoFactura = "RESPONSABLE INSCRIPTO" Then
            ' FACTURA A
            XrLabel9.Text = "Código N° 003"
        ElseIf TipoFactura = "CONSUMIDOR FINAL" Then
            ' FACTURA B
            XrLabel9.Text = "Código N° 008"
        ElseIf TipoFactura = "MONOTRIBUTISTA EXENTO" Then
            ' FACTURA C
            XrLabel9.Text = "Código N° 013"
        End If
    End Sub
    Private Sub XrLabel12_BeforePrint(sender As Object, e As PrintEventArgs) Handles XrLabel12.BeforePrint
        XrLabel12.Text = "N° " & nroNotaCredito
    End Sub
